...
export default ({
  ...
  description = "Our GRC training course is meticulously designed by seasoned professionals with years of industry experience. Combining practical insights and real-world applications, our curriculum ensures you gain the expertise needed to excel. We believe in making top-tier education accessible, offering our course at a competitive price without compromising on quality. Invest in your future with our affordable, expert-led GRC training.",
  ...
  const defaultFeatures = [
    {
      ...
      description: "Developed by industry experts, providing cutting-edge knowledge to excel in GRC.",
      iconContainerCss: tw`bg-teal-300 text-teal-800`
    },
    {
      Icon: MoneyIcon,
      title: "Affordable",
      description: "Top-quality training at a competitive price, making exceptional GRC education accessible to all.",
